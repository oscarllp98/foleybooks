...
/**
 * Renders security-filter rejections (deny-by-default, non-public methods, fail-closed
 ...
 * catalog-service — a resource server — these rejections are real traffic, not
 * theoretical (ADR-007 copies this pattern from auth-service AU-04).
 */
@Component
