 ...
 * Slice pinned to the probe controllers so this proof stays stable when the real
 * CartController joins the classpath (same reason as in {@code SecurityConfigTest}).
 */
