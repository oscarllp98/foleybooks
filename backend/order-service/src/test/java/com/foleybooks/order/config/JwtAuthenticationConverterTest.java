 ...
 * ({@code ADMIN}/{@code CUSTOMER}, AGENTS.md §5); the metrics matcher and the cart's
 * {@code @PreAuthorize} rules speak {@code hasRole(...)}. This test pins the ADR-008
 * mapping SecurityConfig copies from catalog (D-14).
 */
